#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""fixed114 - recon only: inbounds() + callers (prepare /inbounds/list/slim)"""
import io, json, os, re

ROOT = os.environ.get("SRC_ROOT") or os.getcwd()
BUILD = (os.environ.get("NEW_BUILD") or "fixed114").strip() or "fixed114"
...
def grep_tree(tag, pattern, limit=60, exts=(".php",)):
...
dump_find("XUI3 inbounds", "app/Panel/Xui3.php", r"public function inbounds", before=16, after=72)
dump_find("XUI facade inbounds", "app/Panel/Xui.php", r"public function inbounds", before=4, after=26)
grep_tree("inbounds callers", r"->inbounds\(", 40)
grep("PANELS inbound view", "admin/pages/panels.php", r"inbounds\(|\$inbId|listInbounds", 24)
